...
from src_py.air_supervision.modules.generic_model import GenericModel, _register_event,RETURN_TYPE
...
class MultiOutputSVR(GenericModel):
    ...
    async def create_instance(self):
        await super()._create_instance('air_supervision.aimm.model.' + self.name)
